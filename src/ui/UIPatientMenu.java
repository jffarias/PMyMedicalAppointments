...
public class UIPatientMenu {
    ...
    public static void showPatientMenu() throws ParseException{
        ...
        do{
            ...
            System.out.println("1. Show Book Appointments");
    ...
    private static void showBookAppointmentMenu(){
        ...
        do{
           ...
           if(response != 0){
               System.out.println("\n");
               Map<Integer, Doctor> doctorAvailableSelected = doctors.get(response);
                Integer indexDate = 0;
        ...
        do{
            ...
            for(int  i = 0; i<UIMenu.patientLogged.getAppointmentDoctors().size(); i++){
                ...
                System.out.println(j + " . "+
                        "Date: "+UIMenu.patientLogged.getAppointmentDoctors().get(i).getDate(null)+
